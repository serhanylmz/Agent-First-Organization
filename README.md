...
2. Create a config file, similar to the `agentorg\orchestrator\examples\ecommerce_assistant.json` or `agentorg\orchestrator\examples\healthcare_screener.json`
